        ...
        sections: [
            {
                ...
                questions: [
                    { id: 'studySite', label: 'Study Site', type: 'text', required: true },
        ...
        sections: [
            {
                ...
                title: 'Basic Information',
                questions: [
                    { id: 'facility', label: 'Facility', type: 'text', required: true },
                    { id: 'date', label: 'Date', type: 'date', required: true },
                    { id: 'interviewer', label: 'Interviewer Initials', type: 'text', maxlength: 5, required: true }
                ]
            },
            ...
            },
            {
                ...
                questions: [
                    ...
                    },
                    {
                        ...
                        scale: [1, 2, 3, 4, 5],
                        items: [
                            { id: 'c3', text: 'C3. HTN needs lifelong treatment' },
            ...
            },
            {
                ...
                questions: [
                    ...
                    },
                    {
                        ...
                        type: 'checkbox',
                        options: ['HTN information', 'Medication training', 'Financial support', 'Transport help', 'BP monitor', 'Support groups', 'Respite care', 'Tracking app', 'Provider contact', 'Other']
                    }
                ]
            },
            {
                ...
                questions: [
                    {
                        ...
                        label: 'H1. Readiness to support HTN care innovations?',
                        type: 'select',
                        required: true,
